...
first_plot = dcc.Graph(id='scatterplot1',
...
second_plot = dcc.Graph(id='scatterplot2',
                    figure={'data':[go.Scatter(x=random_x,y=random_y,mode='markers',
                        marker={'size':12,'color':'rgb(200,204,53)','symbol':'pentagon','line':{'width':2}})],
                            'layout':go.Layout(title='my scatterplot 2',xaxis={'title':'some x title'})})

app.layout = html.Div([first_plot,second_plot])
